...
I know there are turnkey tools built for this kind of thing, and many of them are practically frictionless. But they are often paid or require you to duplicate your content into their own dashboards. Even then, there was still the issue of how to actually get the Markdown into an email. I looked at several solutions ranging from basic automation hooks to full on marketing platforms that do it all for you, but I thought...
...
- **Timing**: The email sends _before_ the build finishes. Technically, for a few minutes, the link in the email 404s until Cloudflare swaps the deployment. I call this "building anticipation".
